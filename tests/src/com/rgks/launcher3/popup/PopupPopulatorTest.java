...
public class PopupPopulatorTest {
    ...
    public void testSortAndFilterShortcuts() {
        ...
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 0), PopupPopulator.MAX_SHORTCUTS, 0);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(0, 5), 0, PopupPopulator.MAX_SHORTCUTS);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(3, 3),
                PopupPopulator.MAX_SHORTCUTS - PopupPopulator.NUM_DYNAMIC, PopupPopulator.NUM_DYNAMIC);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 5),
                PopupPopulator.MAX_SHORTCUTS - PopupPopulator.NUM_DYNAMIC, PopupPopulator.NUM_DYNAMIC);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(5, 1), PopupPopulator.MAX_SHORTCUTS - 1, 1);
        filterShortcutsAndAssertNumStaticAndDynamic(createShortcutsList(1, 5), 1, PopupPopulator.MAX_SHORTCUTS - 1);
