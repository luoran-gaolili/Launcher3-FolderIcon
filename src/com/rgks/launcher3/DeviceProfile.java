...
public class DeviceProfile {
    ...
    private void adjustToHideWorkspaceLabels() {
        ...
        //modify by luoran for icon display(start)
    ...
    private void updateIconSize(float scale, Resources res, DisplayMetrics dm) {
        ...
        //add by luoran for apps icon display(start)
        iconTextSizePx = 18;
        //add by luoran for apps icon display(end)
    ...
    private void updateFolderCellSize(float scale, DisplayMetrics dm, Resources res) {
        ...
        //modify by luoran for icon display(start)
        folderCellWidthPx = folderChildIconSizePx + 3 * cellPaddingX;
        folderCellHeightPx = folderChildIconSizePx + 4 * cellPaddingY + textHeight;
        folderChildDrawablePaddingPx = Math.max(0,
                (folderCellHeightPx - folderChildIconSizePx - textHeight) / 3);
        //modify by luoran for icon display(end)
    }
