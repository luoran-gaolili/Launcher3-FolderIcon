...
import com.rgks.launcher3.dynamicui.ExtractionUtils;
import com.rgks.launcher3.graphics.LauncherIcons;
import com.rgks.launcher3.model.AddWorkspaceItemsTask;
import com.rgks.launcher3.model.BaseModelUpdateTask;
import com.rgks.launcher3.model.BgDataModel;
import com.rgks.launcher3.model.CacheDataUpdatedTask;
import com.rgks.launcher3.model.LoaderResults;
import com.rgks.launcher3.model.LoaderTask;
import com.rgks.launcher3.model.ModelWriter;
import com.rgks.launcher3.model.PackageInstallStateChangedTask;
import com.rgks.launcher3.model.PackageItemInfo;
import com.rgks.launcher3.model.PackageUpdatedTask;
import com.rgks.launcher3.model.ShortcutsChangedTask;
import com.rgks.launcher3.model.UserLockStateChangedTask;
import com.rgks.launcher3.model.WidgetItem;
import com.rgks.launcher3.provider.LauncherDbUtils;
import com.rgks.launcher3.ragentek.config.RGKGeneralConfig;
...
import com.rgks.launcher3.util.Preconditions;
        ...
        if (Intent.ACTION_LOCALE_CHANGED.equals(action)) {
            ...
            try {
                ...
                if (keyguardWallpaperEntry != null) {
                    ...
                    wpm.setStream( keyguardStream, null, true, WallpaperManager.FLAG_LOCK);
           ...
           // forceReload();
            ...
            if(Intent.ACTION_DATE_CHANGED.equals(action) ||
                ...
                enqueueModelUpdateTask(new PackageUpdatedTask(PackageUpdatedTask.OP_UPDATE,
                        Process.myUserHandle(),new String[]{packageName}));
            }
        }
