...
import com.rgks.launcher3.PagedView;
...
import com.rgks.launcher3.FocusHelper;
...
public class FolderPagedView extends PagedView {
    ...
    public void setFolder(Folder folder) {
        ...
        mPageIndicator = folder.findViewById(com.rgks.launcher3.R.id.folder_page_indicator);
    ...
    public View createNewView(ShortcutInfo item) {
        final BubbleTextView textView = (BubbleTextView) mInflater.inflate(
                com.rgks.launcher3.R.layout.folder_application, null, false);
    ...
    private CellLayout createAndAddNewPage() {
        ...
        CellLayout page = (CellLayout) mInflater.inflate(com.rgks.launcher3.R.layout.folder_page, this, false);
    ...
    public String getAccessibilityDescription() {
        return getContext().getString(com.rgks.launcher3.R.string.folder_opened, mGridCountX, mGridCountY);
    }
