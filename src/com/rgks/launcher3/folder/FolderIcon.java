...
import static com.rgks.launcher3.folder.PreviewItemManager.INITIAL_ITEM_ANIMATION_DURATION;
...
public class FolderIcon extends FrameLayout implements FolderInfo.FolderListener {
    ...
    private void init() {
        ...
        mPreviewLayoutRule = FeatureFlags.LAUNCHER3_LEGACY_FOLDER_ICON ?
                new StackFolderIconLayoutRule(getContext(),this) :
                new ClippedFolderIconLayoutRule(getContext(),this);
        //modify by luoran for folder display 20170109(end)
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        MTKUnreadLoader.drawUnreadEventIfNeed(canvas, this);//add unread feature by luoran DWEQLSY-351
        drawBadge(canvas);
    }
