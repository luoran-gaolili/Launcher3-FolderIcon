...
package com.rgks.launcher3.notification;
...
import com.rgks.launcher3.logging.UserEventDispatcher.LogContainerProvider;
import com.rgks.launcher3.popup.PopupItemView;
import com.rgks.launcher3.touch.SwipeDetector;
...
public class NotificationItemView extends PopupItemView implements LogContainerProvider {
    ...
    protected void onFinishInflate() {
        ...
        mHeaderText = findViewById(com.rgks.launcher3.R.id.notification_text);
        mHeaderCount = findViewById(com.rgks.launcher3.R.id.notification_count);
        mMainView = findViewById(com.rgks.launcher3.R.id.main_view);
        mFooter = findViewById(com.rgks.launcher3.R.id.footer);
    ...
    public int getHeightMinusFooter() {
        ...
        int excessFooterHeight = mFooter.getHeight() - getResources().getDimensionPixelSize(
                com.rgks.launcher3.R.dimen.notification_empty_footer_height);
    ...
    public Animator animateHeightRemoval(int heightToRemove, boolean shouldRemoveFromTop) {
        ...
        View bottomGutter = findViewById(com.rgks.launcher3.R.id.gutter_bottom);
            ...
            if (mNotificationHeaderTextColor == Notification.COLOR_DEFAULT) {
                mNotificationHeaderTextColor =
                        IconPalette.resolveContrastColor(getContext(), palette.dominantColor,
                                Themes.getAttrColor(getContext(), com.rgks.launcher3.R.attr.popupColorPrimary));
            }
