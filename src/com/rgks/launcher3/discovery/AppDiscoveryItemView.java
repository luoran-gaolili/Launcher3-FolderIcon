...
package com.rgks.launcher3.discovery;
...
public class AppDiscoveryItemView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mImage = (ImageView) findViewById(com.rgks.launcher3.R.id.image);
        this.mTitle = (TextView) findViewById(com.rgks.launcher3.R.id.title);
        this.mRatingText = (TextView) findViewById(com.rgks.launcher3.R.id.rating);
        this.mRatingView = (RatingView) findViewById(com.rgks.launcher3.R.id.rating_view);
        this.mPrice = (TextView) findViewById(com.rgks.launcher3.R.id.price);
        this.mReviewCount = (TextView) findViewById(com.rgks.launcher3.R.id.review_count);
    }
