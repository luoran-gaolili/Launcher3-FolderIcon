...
import com.rgks.launcher3.Workspace.ItemOperator;
...
import com.rgks.launcher3.allapps.AllAppsTransitionController;
import com.rgks.launcher3.anim.AnimationLayerSet;
import com.rgks.launcher3.compat.AppWidgetManagerCompat;
import com.rgks.launcher3.compat.LauncherAppsCompat;
import com.rgks.launcher3.compat.LauncherAppsCompatVO;
import com.rgks.launcher3.compat.UserManagerCompat;
import com.rgks.launcher3.config.FeatureFlags;
import com.rgks.launcher3.dragndrop.DragController;
import com.rgks.launcher3.dragndrop.DragLayer;
import com.rgks.launcher3.dragndrop.DragOptions;
import com.rgks.launcher3.dragndrop.DragView;
import com.rgks.launcher3.dragndrop.PinItemDragListener;
import com.rgks.launcher3.dynamicui.ExtractedColors;
import com.rgks.launcher3.dynamicui.WallpaperColorInfo;
import com.rgks.launcher3.folder.Folder;
import com.rgks.launcher3.folder.FolderIcon;
import com.rgks.launcher3.keyboard.CustomActionsPopup;
import com.rgks.launcher3.keyboard.ViewGroupFocusHelper;
import com.rgks.launcher3.logging.FileLog;
import com.rgks.launcher3.logging.UserEventDispatcher;
import com.rgks.launcher3.model.ModelWriter;
import com.rgks.launcher3.model.PackageItemInfo;
import com.rgks.launcher3.model.WidgetItem;
import com.rgks.launcher3.notification.NotificationListener;
import com.rgks.launcher3.pageindicators.PageIndicator;
import com.rgks.launcher3.popup.PopupContainerWithArrow;
import com.rgks.launcher3.popup.PopupDataProvider;
import com.rgks.launcher3.shortcuts.DeepShortcutManager;
import com.rgks.launcher3.userevent.nano.LauncherLogProto;
import com.rgks.launcher3.userevent.nano.LauncherLogProto.Action;
import com.rgks.launcher3.userevent.nano.LauncherLogProto.ContainerType;
import com.rgks.launcher3.userevent.nano.LauncherLogProto.ControlType;
import com.rgks.launcher3.util.ActivityResultInfo;
import com.rgks.launcher3.util.RunnableWithId;
import com.rgks.launcher3.util.ComponentKey;
import com.rgks.launcher3.util.ComponentKeyMapper;
import com.rgks.launcher3.util.ItemInfoMatcher;
import com.rgks.launcher3.util.MultiHashMap;
import com.rgks.launcher3.util.PackageManagerHelper;
import com.rgks.launcher3.util.PackageUserKey;
import com.rgks.launcher3.util.PendingRequestArgs;
import com.rgks.launcher3.util.SystemUiController;
import com.rgks.launcher3.util.TestingUtils;
import com.rgks.launcher3.util.Themes;
import com.rgks.launcher3.util.Thunk;
import com.rgks.launcher3.util.ViewOnDrawExecutor;
import com.rgks.launcher3.widget.PendingAddShortcutInfo;
import com.rgks.launcher3.widget.PendingAddWidgetInfo;
import com.rgks.launcher3.widget.WidgetAddFlowHandler;
...
import static com.rgks.launcher3.util.RunnableWithId.RUNNABLE_ID_BIND_APPS;
import static com.rgks.launcher3.util.RunnableWithId.RUNNABLE_ID_BIND_WIDGETS;
...
public class Launcher extends BaseActivity
        implements LauncherExterns, View.OnClickListener, OnLongClickListener,
                   ...
                   WallpaperColorInfo.OnThemeChangeListener,MTKUnreadLoader.UnreadCallbacks {
    ...
    //add unread feature by luoran DWEQLSY-351 start
    ...
    //add unread feature by luoran DWEQLSY-351 end
    /**
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.rgks.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getResources().getBoolean(R.bool.config_unreadSupport)) {
            ...
            filter.addAction(FeatureFlags.ACTION_UNREAD_CHANGED);
...
//            UnreadContentObserver.getUnreadContentObserver(this).getUnreadMms();
    ...
    public void finishFirstPageBind(final ViewOnDrawExecutor executor) {
        ...
        //add by luoran for default workspace screen 20180111(start)
        if(mWorkspace != null) {
            mWorkspace.moveToDefaultScreen(true);
        }
        //add by luoran for default workspace screen 20180111(end)
    }
