...
import com.rgks.launcher3.util.ContentWriter;
import com.rgks.launcher3.util.ItemInfoMatcher;
import com.rgks.launcher3.util.LooperExecutor;
...
public class ModelWriter {
    ...
    public void addItemToDatabase(final ItemInfo item,
        ...
        item.id = LauncherSettings.Settings.call(cr, LauncherSettings.Settings.METHOD_NEW_ITEM_ID).getLong(LauncherSettings.Settings.EXTRA_VALUE);
        writer.put(LauncherSettings.Favorites._ID, item.id);

        final StackTraceElement[] stackTrace = new Throwable().getStackTrace();
        mWorkerExecutor.execute(new Runnable() {
            public void run() {
                cr.insert(LauncherSettings.Favorites.CONTENT_URI, writer.getValues(mContext));
    ...
    private class UpdateItemRunnable extends UpdateItemBaseRunnable {
        ...
        @Override
        public void run() {
            Uri uri = LauncherSettings.Favorites.getContentUri(mItemId);
