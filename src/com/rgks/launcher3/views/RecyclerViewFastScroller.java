...
package com.rgks.launcher3.views;
...
import com.rgks.launcher3.graphics.FastScrollThumbDrawable;
...
public class RecyclerViewFastScroller extends View {
    ...
    public RecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mWidth = mMinWidth = res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.fastscroll_track_min_width);
        mMaxWidth = res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.fastscroll_track_max_width);

        mThumbPadding = res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.fastscroll_thumb_padding);
        mThumbHeight = res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.fastscroll_thumb_height);

        mConfig = ViewConfiguration.get(context);
        mDeltaThreshold = res.getDisplayMetrics().density * SCROLL_DELTA_THRESHOLD_DP;

        TypedArray ta =
                context.obtainStyledAttributes(attrs, com.rgks.launcher3.R.styleable.RecyclerViewFastScroller, defStyleAttr, 0);
        mCanThumbDetach = ta.getBoolean(com.rgks.launcher3.R.styleable.RecyclerViewFastScroller_canThumbDetach, false);
        ta.recycle();
    }
