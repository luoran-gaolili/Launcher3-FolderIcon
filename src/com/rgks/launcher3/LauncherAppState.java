...
import com.rgks.launcher3.util.SettingsObserver;
import com.rgks.launcher3.util.TestingUtils;

import java.util.concurrent.Callable;
import java.util.concurrent.ExecutionException;

import static com.rgks.launcher3.SettingsActivity.NOTIFICATION_BADGING;
...
public class LauncherAppState {
    ...
    private LauncherAppState(Context context) {
        ...
        if(mContext.getResources().getBoolean(R.bool.support_calendar_icon)){
