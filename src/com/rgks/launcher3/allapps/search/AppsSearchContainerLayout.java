 ...
 */
package com.rgks.launcher3.allapps.search;
...
import com.rgks.launcher3.allapps.AllAppsGridAdapter;
import com.rgks.launcher3.allapps.AllAppsRecyclerView;
import com.rgks.launcher3.allapps.AlphabeticalAppsList;
import com.rgks.launcher3.allapps.SearchUiManager;
import com.rgks.launcher3.discovery.AppDiscoveryItem;
import com.rgks.launcher3.discovery.AppDiscoveryUpdateState;
import com.rgks.launcher3.graphics.TintedDrawableSpan;
...
public class AppsSearchContainerLayout extends FrameLayout
    ...
    public AppsSearchContainerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinHeight = getResources().getDimensionPixelSize(com.rgks.launcher3.R.dimen.all_apps_search_bar_height);
        mSearchBoxHeight = getResources()
                .getDimensionPixelSize(com.rgks.launcher3.R.dimen.all_apps_search_bar_field_height);
    ...
    protected void onFinishInflate() {
        ...
        mSearchInput = findViewById(com.rgks.launcher3.R.id.search_box_input);
        mDivider = findViewById(com.rgks.launcher3.R.id.search_divider);
        ...
        spanned.setSpan(new TintedDrawableSpan(getContext(), com.rgks.launcher3.R.drawable.ic_allapps_search),
