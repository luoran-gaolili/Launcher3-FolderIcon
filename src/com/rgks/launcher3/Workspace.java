...
import com.rgks.launcher3.LauncherAppWidgetHost.ProviderChangedListener;
import com.rgks.launcher3.UninstallDropTarget.DropTargetSource;
import com.rgks.launcher3.accessibility.AccessibleDragListenerAdapter;
import com.rgks.launcher3.accessibility.OverviewAccessibilityDelegate;
...
import com.rgks.launcher3.badge.FolderBadgeInfo;
...
import com.rgks.launcher3.dragndrop.SpringLoadedDragController;
import com.rgks.launcher3.folder.Folder;
import com.rgks.launcher3.folder.FolderIcon;
import com.rgks.launcher3.folder.PreviewBackground;
import com.rgks.launcher3.graphics.DragPreviewProvider;
import com.rgks.launcher3.graphics.PreloadIconDrawable;
import com.rgks.launcher3.popup.PopupContainerWithArrow;
import com.rgks.launcher3.shortcuts.ShortcutDragPreviewProvider;
...
import com.rgks.launcher3.util.VerticalFlingDetector;
import com.rgks.launcher3.util.WallpaperOffsetInterpolator;
...
public class Workspace extends PagedView
    ...
    //add by luoran for default workspace screen(start)
    private int default_home_screen;
    //add by luoran for default workspace screen(end)
    /**
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        default_home_screen = mLauncher.getResources().getInteger(R.integer.config_workspaceDefaultScreen);
   ...
   void mapPointFromChildToSelf(View v, float[] xy) {
    ...
    void moveToDefaultScreen(boolean animate) {
        //modify by luoran for default workspace screen 20180111(start)
        int page = default_home_screen;
        //modify by luoran for default workspace screen 20180111(end)
