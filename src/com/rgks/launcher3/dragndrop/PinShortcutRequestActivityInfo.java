...
import com.rgks.launcher3.compat.ShortcutConfigActivityInfo;
...
class PinShortcutRequestActivityInfo extends ShortcutConfigActivityInfo {
    ...
    @Override
    public com.rgks.launcher3.ShortcutInfo createShortcutInfo() {
        // Total duration for the drop animation to complete.
        long duration = mContext.getResources().getInteger(com.rgks.launcher3.R.integer.config_dropAnimMaxDuration) +
                Launcher.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT +
                mContext.getResources().getInteger(com.rgks.launcher3.R.integer.config_overlayTransitionTime) / 2;
